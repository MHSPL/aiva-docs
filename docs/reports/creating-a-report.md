...
description: Step-by-step guide to creating clinical and research reports in AIVA with the rich text editor.
---
...
- **Body content** that you write or generate with [AI Auto-Fill](ai-auto-fill.md).
- Optional **linked evidence** from your sample data (see [Sample Linking](sample-linking.md)).
...
Click the **AI Auto-Fill** button on any section to have AIVA generate content based on your sample data and analysis findings. See [AI Auto-Fill](ai-auto-fill.md) for details.

### Linked Evidence

Insert references to flagged variants, ACMG classifications, and comments from your analysis. See [Sample Linking](sample-linking.md) for details.
