...
!!! tip "Used to filtering by hand?"
    If you interpret variants with filter cascades in tools like Franklin, VarSeq, or Alissa, see the [Filters to Prompts cheat sheet](../cheat-sheet.md). It maps every filter you know to an AIVA prompt and shows when to lean on chat versus the table below.
