...
description: Use AIVA's Analysis Panel to run category-based analyses with customizable layouts and multiple analysis panels in a unified workspace.
---
...
- **Categories**: Groupings of related annotation columns (e.g., Clinical Significance, Pharmacogenomics, Protein Function). See [Categories](categories.md).
