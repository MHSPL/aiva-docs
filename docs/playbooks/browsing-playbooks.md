---
title: Browsing Playbooks
description: Explore the AIVA playbook marketplace to find community-contributed analysis workflows for genomic data.
---
...
2. The marketplace displays available playbooks organized by category.
...
1. Click **Use Playbook** on the playbook detail page.
2. Select the sample you want to analyze.
3. AIVA opens a new conversation and begins executing the playbook steps.
4. Follow along as AIVA works through each step, asking for your input when needed.
...
2. A copy of the playbook is created in your personal playbook library.
3. Edit the forked playbook to adjust steps, add new instructions, or remove unnecessary steps.
...
See [Creating Playbooks](creating-playbooks.md) for details on editing playbook content.
